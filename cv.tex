...
% --- Contact ---
\rue{Bât K4, Résidence les Pugets,\\ 
\hphantom{XX}101, rue Jean Giono}
\codePostal{06700}
...
\noindent\years{2009 $\rightarrow$}\emph{Co-Founder} \amper{} \emph{Freelance}, GridPocket, Sophia Antipolis.\\
\noindent\years{2007 $\rightarrow$}\emph{Consultant}, Air France (Astek), Sophia Antipolis.\\
...
\years{\hspace{1.3em}$\rightarrow$ 1999}\emph{Misc. summer jobs}, {\footnotesize (Eurocopter, Naphtachimie, LCL...) } near Marseille.
...
\deuxcolones{Data Minning}{Entreprise Miner (SAS), weka, $\textrm{\bsc{svm}}_\textrm{\scriptsize{\textit{light}}}$}
