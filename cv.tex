...
\years{2004-2005}\emph{\textsc{ATER} {\footnotesize (Attaché Temporaire d'Enseignement et de Recherche)}}, Université de Provence, Marseille \\
...
\noindent\years{2001}\emph{\textsc{DEA} d'informatique} , Université de la Méditerranée, Marseille\\
...
\noindent\years{1998}\emph{\textsc{DEUG MIAS} {\footnotesize option mathématiques}}, Université de Provence, Marseille\\
\noindent\years{1995}\emph{\textsc{BAC S} {\footnotesize option mathématiques}}, Lycée P. Langevin, Martigues\\
...
\footnotesize{Pour plus de détails voir mon ancien site \href{http://www.lif.univ-mrs.fr/~esposito}{\texttt{http://www.lif.univ-mrs.fr/~esposito}}
