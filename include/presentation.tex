...
% ---- CUSTOM AMPERSAND
\newcommand{\amper}{{\fontspec[Scale=.95]{Georgia}\selectfont\itshape\&}}
...
% français
% probleme des : aprés le http en français
\usepackage[english,french]{babel} % pour le français
\selectlanguage{french}
\let\hreforig\href
\renewcommand{\href}[2]{\hreforig{#1}{{\texttt{\selectlanguage{english}#2}}}}
